...
//#region reverse the strings (candidate name) and (values)
    const reverseString = (str) => {
        return str.split('').reverse().join('');
    };
//#endregion
    const handleButtonClick = () => {
        setreverseStrings(!reverseStrings);
    };
            ...
            return (
                <div className="resDiv">
                    ...
                    <ol>
                        {sumofAllResult.map(([candidate, votes]) => (
                            <li id="ress" key={candidate}>
                                {reverseStrings
                                    ? `${reverseString(formatName(candidate))}: ${reverseString(formatVotes(votes))} votes`
                    ...
                    <button onClick={handleButtonClick}>
                        {reverseStrings ? "Restore Strings" : "Reverse Strings"}
                    </button>
                </div>
            );
